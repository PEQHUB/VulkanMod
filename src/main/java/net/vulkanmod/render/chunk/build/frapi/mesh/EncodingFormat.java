...
public final class EncodingFormat {
	...
	static {
		final VertexFormat format = class_290.field_1590;
	...
	private static final @Nullable class_11515[] NULLABLE_BLOCK_RENDER_LAYERS = ArrayUtils.add(class_11515.values(), null);
	...
	private static final class_10444.@Nullable class_10445[] NULLABLE_GLINTS = ArrayUtils.add(class_10444.class_10445.values(), null);
	...
	private static final int CULL_BIT_LENGTH = class_3532.method_15342(NULLABLE_DIRECTION_COUNT);
	private static final int LIGHT_BIT_LENGTH = class_3532.method_15342(DIRECTION_COUNT);
	private static final int NORMALS_BIT_LENGTH = 4;
	private static final int GEOMETRY_BIT_LENGTH = GeometryHelper.FLAG_BIT_COUNT;
	private static final int RENDER_LAYER_BIT_LENGTH = class_3532.method_15342(NULLABLE_BLOCK_RENDER_LAYER_COUNT);
	private static final int EMISSIVE_BIT_LENGTH = 1;
	private static final int DIFFUSE_BIT_LENGTH = 1;
	private static final int AO_BIT_LENGTH = class_3532.method_15342(TRI_STATE_COUNT);
	private static final int GLINT_BIT_LENGTH = class_3532.method_15342(NULLABLE_GLINT_COUNT);
	private static final int SHADE_MODE_BIT_LENGTH = class_3532.method_15342(SHADE_MODE_COUNT);
	private static final int QUAD_ATLAS_BIT_LENGTH = class_3532.method_15342(QUAD_ATLAS_COUNT);
	...
	@Nullable
	static class_11515 renderLayer(int bits) {
